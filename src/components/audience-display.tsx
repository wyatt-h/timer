  ...
  return (
    ...
    >
      ...
      <section className={cn("relative z-2 flex flex-1 flex-col items-center justify-center gap-[clamp(0.75rem,2vw,1.375rem)] py-[clamp(0.75rem,2.5vh,2rem)] text-center", isPanel && "has-panel-total")}>
        ...
        <div
          className={cn(
            "tabular font-mono leading-[1.04] tracking-[-0.06em] text-[#f8f7fc] transition-colors duration-300",
        ...
        >
          <i
            className={cn(
              ...
              speakerTone === "critical" ? "bg-[#ff7a70]" : speakerTone === "caution" ? "bg-[#ffb547]" : "bg-white/55",
            )}
